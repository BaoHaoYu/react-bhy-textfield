...
var Text = function (_React$Component) {
    ...
    _createClass(Text, [{
        ...
        value: function _isWarn() {
            var $$data = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5_immutable_contrib_cursor__["from"])(this.state.$$s, ['data']);
            var p = this.props;
        ...
        value: function render() {
            ...
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
                { className: css.combine('BhyTextFile', isWarn && '-warn', $$data.get('focus') && '-focus') + ' ' + p.className },
...
Text.propTypes = {
    ...
    rex: __WEBPACK_IMPORTED_MODULE_0_react___default.a.PropTypes.any,
    ...
    rexPassIsRight: __WEBPACK_IMPORTED_MODULE_0_react___default.a.PropTypes.bool,
